...
namespace MyWindowsBlogReader
{
    ...
    /// the currently selected item. Source of this page are feeds from the source feedDatSource
    /// </summary>
    public sealed partial class SplitPage_Level1 : Page
    {
        ...
        public SplitPage_Level1()
        {
            ...
            this.navigationHelper.GoBackCommand = new MyWindowsBlogReader.Common.RelayCommand(() => this.GoBack(), () => this.CanGoBack());
        ...
        private void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            if (e != null)
            {
                string feedTitle = e.NavigationParameter as string;
            ...
            else
            {
                ...
                if (e.PageState.ContainsKey("SelectedItem") && this.itemsViewSource.View != null)
                {
                    ...
                    string itemTitle = (string)e.PageState["SelectedItem"];
        ...
        private void navigationHelper_SaveState(object sender, SaveStateEventArgs e)
        {
            ...
            {
                //       Derive a serializable navigation parameter and assign it to
                //       pageState("SelectedItem")
                var selectedItem = this.itemsViewSource.View.CurrentItem;
                if (selectedItem != null)
                {
                    string itemTitle = (selectedItem as FeedItem).Title;
        ...
        //if no internet connection or other error occured
        ...
        private void ViewDetail_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (selectedItem != null)
            {
                if (this.Frame != null)
                {
                    ...
                    this.Frame.Navigate(typeof(DetailPage_Level2), itemTitle);
                }            
            }
        }
    }
