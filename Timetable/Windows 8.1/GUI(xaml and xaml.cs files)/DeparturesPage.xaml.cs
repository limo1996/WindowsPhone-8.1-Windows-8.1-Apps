...
namespace Timetable.Pages
{
    ...
    public sealed partial class DeparturesPage : Page
    {
        ...
        public DeparturesPage()
        {
            ...
            this.navigationHelper.GoBackCommand = new Timetable.Common.RelayCommand(() => this.GoBack(), () => this.CanGoBack());
        ...
        private void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            this.defaultViewModel["Items"] = (App.Current.Resources["Results"] as ResultsContainer).Results;
            this.pageTitle.Text = (App.Current.Resources["Results"] as ResultsContainer).Title;
            if (e.PageState == null)
            {
        ...
        private void ItemListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (selector != null)
            {
                Result result = selector.SelectedItem as Result;
                if(result != null)
                {
                    this.DetailTitle.Text = result.Title;
                    this.DetailSubTitle.Text = result.StartTime;
                    this.DetailSubSubTitle.Text = result.SmallInfo;
                    this.DetailContent.Text = result.DetailsOfLine;
                }
            }
        }
