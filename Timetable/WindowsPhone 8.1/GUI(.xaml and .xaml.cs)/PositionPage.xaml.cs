...
namespace Timetable.Pages
{
    ...
    public sealed partial class PositionPage : Page
    {
        ...
        {
            fromPosition = (bool)e.NavigationParameter;
        }
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    station = "Empty database !";
                }
            }
            this.Frame.Navigate(typeof(MainPage), Tuple.Create<bool, string>(fromPosition, station));
